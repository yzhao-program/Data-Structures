...
public class TreeIterator<E> implements java.util.Iterator<E> {
	...
	/**
	 * An ordered list of nodes traversed by this iterator. Empty list indicates no
	 * traversal type currently selected or end of current traversal has been reached
	 */
	...
	/**
	 * Removes from the underlying binary tree the last element returned by this
	 * iterator (optional operation). It can be called only once per call to next()
	 * method. The behavior of an iterator is unspecified if the underlying
	...
	public void remove() throws UnsupportedOperationException {
		// Optional means we can implement it or throw an UnsupportedOperationException.
		// This operation is optional because
		// sometimes we just don't want the iterator's content to be modified. An
		// iterator is normally used for executing.
